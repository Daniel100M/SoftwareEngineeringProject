...
class RegistrationForm(FlaskForm):
    ...
    food_type = SelectField('Food Type', choices=[('italian', 'Italian'), ('mexican', 'Mexican'), ('chinese', 'Chinese'), ('vegetarian', 'Vegetarian'),('meat', 'Meat'),('coffee house','Coffee House'),('fast food','Fast Food'),('bar','Bar'),('sea food','Sea Food'),('bakery','Bakery'),('ice cream','Ice Cream'),('desserts','Desserts')], validators=[DataRequired()])
